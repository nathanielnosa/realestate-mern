    ...
    return (
        <section id="profile" className="py-8 bg-[#fcfcfd] dark:bg-[#000] h-screen">
            <div className="text-center">
                ...
                <div className="text-center flex md-flex-row py-3 px-4 w-[60%] mx-auto  items-center gap-4  justify-center border rounded-md my-[3rem]">
                    <div className="w-full">
                        <img src={currentUser.avatar} alt="profile" className='self-center rounded-full object-cover cursor-pointer dark:border-[#fff] border-[3px]' />
                    </div>
                    <div className="w-full">
